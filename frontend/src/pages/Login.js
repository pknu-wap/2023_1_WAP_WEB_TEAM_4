  ...
  return (
    <Stack style={{ backgroundColor: "black" }}>
      ...
      <Stack flexDirection="row">
        ...
        justifyContent: "center", position: "fixed", right: 0 }}>
          <Stack
            width="80%"
            height="150px"
            style={{ alignItems: "center"}}
          >
            <Stack fontWeight="bold" fontSize="20px" color="#ECD8A4" marginBottom="30px">Login</Stack>
            ...
            <Button onClick={() => navigate("/")} variant="outlined" sx={{width:"80%", "&.MuiButton-root": {border: "1px solid #ECD8A4", color: "#ECD8A4"}}}>Login</Button>
          </Stack>
        </Stack>
      </Stack>
    </Stack>
